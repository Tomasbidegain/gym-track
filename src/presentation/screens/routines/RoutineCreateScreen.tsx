...
export function RoutineCreateScreen({ navigation }: RoutineScreenProps<'RoutineCreate'>) {
  ...
  const removeExercise = useCallback(
    (index: number) => {
      ...
      Alert.alert('Eliminar ejercicio', '¿Querés eliminar este ejercicio de la rutina?', [
  ...
  }, [clearFormError, validate, createRoutine, name, description, exercises, picker, navigation]);
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
        ...
        {exercises.length === 0 ? (
          <Text style={styles.noExercisesText}>
            Todavía no agregaste ejercicios. Usá el botón de arriba.
          </Text>
        ) : null}
